...
>
  <head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="<?=PROOT?>assets/img/favicon/favicon.ico" />
    ...
    <!-- Page CSS -->
    <!-- Page -->
    <link rel="stylesheet" href="<?=PROOT?>assets/vendor/css/pages/page-auth.css" />
    <!-- Helpers -->
